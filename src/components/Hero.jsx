  ...
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px6`}>
        <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2 sm:mx-0 mx-5'>
        ...
        <div className='flex flex-row justify-between items-center w-full sm:mx-0 mx-10'>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={robot} alt="robot_pic" className={`w-[100%] h-[100%] relative z-[5]`}/>
